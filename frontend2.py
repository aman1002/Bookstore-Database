...
class Window(object):
    ...
    def __init__(self, window):
        ...
        #window.minsize(width=440, height=220)
        self.window.maxsize(width=440, height=250)
        ...
        b7= Button(window, text= "Close", width= 12, command= window.quit)
    ...
    def update_command(self):
        database.update(self.title_text.get(), self.author_text.get(), self.year_text.get(), self.isbn_text.get(), self.selected_tuple[0])
